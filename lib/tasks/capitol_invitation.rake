namespace :notify do
  ...
  task :capitol_invitation, [:user_tg_id] => :environment do |t,args|
    ...
    group_substitution =case user.group
                              when Group.find(1)
    ...
    " a hard day #{group_substitution}." \
    "\n\n*Pssst....💭\n\"We need to talk...the Capitol 👑, has noticed your skills..."\
    " it is important for the peace of Panem that the Groups be kept in their place,"\
    " reminded they must stay subservient to the Capitol 👑.\"\n\n🔊" \
    "You are being given a great opportunity of a lifetime! - you will be moved to the Capitol Group 👑,"\
    "allowed to fight for us, and keep the other groups in line.  Will you join us?\n\n" \
    ...
    "🔅 A free sponsor prize to help you crush the other group tributes.\n\n" \
    "⛔️But since nothing in this world comes for free; for this as well, you will have to pay a price "\
    "i.e. you will have to renounce and leave your group.\n\n" \
    "Will you join us⁉️\n\n"\
